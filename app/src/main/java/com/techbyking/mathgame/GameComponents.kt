...
fun TextForQuestion(text : String){
    ...
    Text(
        ...
        modifier = Modifier
            ...
            .size(300.dp, 75.dp)
            .wrapContentHeight() // does vertical alignment

    )//end Text block
}//end TextForQuestion scope
...
fun TextFieldForAnswer(text : MutableState<String>){
    ...
    TextField(
        ...
        modifier = Modifier
            .size(300.dp,75.dp),
            textStyle = TextStyle(fontSize = 24.sp, textAlign = TextAlign
                .Center),
            shape = RoundedCornerShape(0),
            keyboardOptions = KeyboardOptions(keyboardType = KeyboardType
                .Number)

    )//end TextField parameters
}//end TextFieldForAnswer fun

@Composable
fun ButtonOkNext(buttonText : String, myOnClick: () -> Unit, isEnabled :
Boolean){
    ...
    {
        Text(text = buttonText, fontSize = 24.sp, color = colorResource(id =
        R.color.blue))
    }//end Row scope

}//end ButtonOkNext fun scope
